                        ...
                        <div class="col-md-10 col-12 mb-2">
                            <div class="service-item-data">
                                ...
                                <div class="service-booking">
                                    ...
                                    <button type="button" class="get btn btn-warning" data-id="{{$lesson->id}}" data-title="{{$lesson->title}}" data-url="{{$lesson->url}}" data-bs-toggle="modal" data-bs-target="#teacherVideos">{{trans('teacher.update')}}</button>
                                </div>
                          ...
                          <div class="container">
                           ...
                           <form action="{{route('update-lesson')}}"  method="POST" enctype="multipart/form-data">   
                               ...
                               <div class="input-item me-auto ms-0">
                                   <input name="title" id="lesson-title"  type="text"  value="{{old('title')}}" placeholder="{{trans('teacher.title')}}">
                                   <span>
                               ...
                               <div class="input-item me-auto ms-0">
                                   <input name="url" id="lesson-url"  type="text"  value="{{old('url')}}" placeholder="{{trans('teacher.url')}}">
                                   <span>
                                       <i class="fa-solid fa-person-chalkboard"></i>
                                   </span>
                                   @error('url')
