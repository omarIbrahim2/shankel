    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap">
        <div class="search_table">
            <form class="form-inline my-2 mb-3 justify-content-center">
                <div class="w-100">
                    <input type="text" wire:model="searchName" class="w-100 form-control product-search br-30"
                    ...
                    <tr>
                        ...
                        <td class="text-center elpsis_controls">
                            ...
                            <div class="d-flex justify-content-center align-items-center flex-wrap">
                                <div><a href="{{ route('service-update-form', ['serviceId' => $service->id, 'supplierid' => $supplierId]) }}"
                                ...
                                <div><a href="{{ route('service-delete', $service->id) }}" class="btn btn-danger mb-2"
