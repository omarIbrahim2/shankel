...
<div class="table-responsive">
    ...
    <div class="search_table">
        <form  class="form-inline my-2 mb-3 justify-content-center">
            <div class="w-100">
                <input type="text" wire:model="NameOrEmail"  class="w-100 form-control product-search br-30" id="input-search" placeholder="Search by Title">
    ...
    <tbody>
        ...
        <tr>
           ...
           <td class="text-center elpsis_controls">
             ...
             @else
             <td class="text-center"><a href="{{ route('teacher-details' , $user['id']) }}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a></td>
             @endif
