            ...
            @else
                @foreach ($Sliders as $slider)
                    <tr>
                        ...
                        <td class="elpsis">{{ $slider->title('en') }}</td>
                        <td class="elpsis">{{ $slider->title('ar') }}</td>
                        <td class="text-center elpsis_controls">

                            <div class="d-flex justify-content-center align-items-center flex-wrap">
                                <div><a href="{{ route('slider-update-form', $slider->id) }}"
                                        class="btn btn-success mb-2" data-toggle="tooltip" data-placement="top"
                                ...
                                <div><a href="{{ route('slider-delete', $slider->id) }}" class="btn btn-danger mb-2"
                                ...
                                <div><a href="{{ route('slider-show', $slider->id) }}" class="btn btn-primary mb-2"
                                        data-toggle="tooltip" data-placement="top" title=""
