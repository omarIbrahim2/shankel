                ...
                <tr>
                    ...
                    <td class="text-center elpsis_controls">
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-wrap">
                            <div><a href="{{ route('infos-update-form', $Infos->id) }}" class="btn btn-success mb-2"
                            ...
                            <div><a href="{{ route('info-delete', $Infos->id) }}" class="btn btn-danger mb-2"
                                    data-toggle="tooltip" data-placement="top" title=""
                            ...
                            <div><a href="{{ route('info-show', $Infos->id) }}" class="btn btn-primary mb-2"
                                    data-toggle="tooltip" data-placement="top" title=""
