...
<div class="table-responsive">
    <div>
       ...
       @if ($guard == "supplier")
       <a href="{{route("create-supplier")}}" class="btn btn-success">Add Supplier</a>    
       @endif
        ...
        <tr>
           ...
           <td class="text-center">
               ...
               <ul class="table-controls">
                   <li><a href="{{route('update-supplier' , $user['id'])}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
                   <li><a href="{{route("supplier-delete" , $user['id'])}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a></li>
                   <li><a href="{{route("Services" , $user['id'])}}">Services</a></li>
                   <td class="text-center"><a href="{{ route("supplier-details" , $user['id']) }}" class="btn btn-eye"><i class="fa-solid fa-eye"></i></a></td>

               </ul>
             </td>     
             @else
             <td class="text-center"><a class="btn btn-eye"><i class="fa-solid fa-eye"></i></a></td>
             @endif
