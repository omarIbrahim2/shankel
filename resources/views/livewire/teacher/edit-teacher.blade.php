                    ...
                    <div class="right-side">
                        <div class="right-side-item">
                            ...
                            <div class="contact-form ">
                                <form>
                                    ...
                                    <div class="input-item">
                                        <input type="text" wire:model.defer="field" placeholder="subject">
                                        <span>
                            ...
                            <div class="contact-form ">
                                    ...
                                    <div class="input-item ">
                                        ...
                                        <label class="file-input" for="teacher">
                                            ...
                                            <p class="upload-text">Upload CV</p>
                        ...
                        <div class="right-side-item">
                            ...
                            <div class="contact-form ">
                                    ...
                                    <div class="input-item">
                                        <input type="url" wire:model.defer="facebook" placeholder="Facebook URL">
                                        <span>
                                    ...
                                    <div class="input-item">
                                        <input type="url" wire:model.defer="twitter" placeholder="Twitter URL">
                                        <span>
                                    ...
                                    <div class="input-item ">
                                        <input type="url" wire:model.defer="linkedin" placeholder="Linkedin URL">
                                        <span>
