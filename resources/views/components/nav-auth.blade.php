    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto">
                @if ($guard == 'web')
                <li class="nav-item">
                    <a class="nav-link active" id="home-nav" aria-current="" href="{{route('home')}}">{{trans("nav.Home")}}</a>
                </li>
                @else
                  <li class="nav-item">
                    <a class="nav-link active" id="home-nav" aria-current="" href="{{route($guard)}}">{{trans("nav.Home")}}</a>
                  </li>
                @endif
                <li class="nav-item">
