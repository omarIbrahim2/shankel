            ...
            <div class="contact-form black-contact-form">
                 <form action="{{route("school-store-event")}}"  method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="input-item me-auto ms-0">
                        <input name="title_en" id="event-title"  type="text"  value="{{old('title_en')}}" placeholder="{{ trans('event.title_en') }}">
                        <span>
                    ...
                    <div class="input-item me-auto ms-0">
                        <input name="title_ar" id="event-title_ar"  type="text"  value="{{old('title_ar')}}" placeholder="{{ trans('event.title_ar') }}">
                        <span>
                            <i class="fa-regular fa-calendar"></i>
                        </span>
                        @error('title_ar')
                    ...
                    <div class="input-item me-auto ms-0">
                        <textarea id="desc_en" name="desc_en"   class="event_desc" placeholder="{{trans("event.desc_en")}}" rows="5" >{{old('desc_en')}}</textarea>
                        <span>
                    ...
                    <div class="input-item me-auto ms-0">
                        <textarea name="desc_ar"  id="desc_ar" class="event_desc" placeholder="{{trans('event.desc_ar')}}" rows="5" >{{old('desc_ar')}}</textarea>
                        <span>
                            <i class="fa-solid fa-quote-right"></i>
                        </span>
                        @error('desc_ar')
                    ...
                    <div class="input-item me-auto ms-0">
                         <input type="text" value="{{old('start_date')}}" name="start_date"  placeholder="{{ trans('event.select') }}"  class="textbox-n eventDayPicker">
                         <span>
