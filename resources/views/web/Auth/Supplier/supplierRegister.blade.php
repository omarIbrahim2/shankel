                            ...
                            <div class="left-side">
                                ...
                                <div class="contact-form black-contact-form">
                                    ...
                                    <form method="POST" action="{{route('supplier-registeration')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="input-item me-auto ms-0">
                                            <input value="{{old("type")}}" type="text" name="type" placeholder="{{ trans('supplier.type') }}">
                                            <span>
                                        ...
                                        <div class="input-item me-auto ms-0">
                                            <input value="{{old("orgName")}}" type="text" name="orgName" placeholder="{{ trans('supplier.orgName') }}">
                                            <span>
