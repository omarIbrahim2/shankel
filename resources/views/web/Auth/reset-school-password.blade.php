                        ...
                        <div class="col-lg-6 col-md-8 col-12">
                            <div class="left-side">
                                <div class="section-title">
                                    <h2 class="text-start">{{ trans('school.enterEmail') }}</h2>
                                </div>
                                <div class="contact-form black-contact-form">
                                    <form method="POST" action="{{ route('password.update', ['broker' => 'schools' , 'guard' => 'school']) }}">
                                        @csrf
                                        ...
                                        <div class="input-item me-auto ms-0">
                                            ...
                                            <input type="email" name="email" placeholder="{{ trans('school.email') }}">
                                            <span>
