                    ...
                    <div class="col-lg-6 col-md-8 col-12">
                        <div class="left-side">
                            <div class="section-title">
                                ...
                                <p class="text-start p-0">{{trans('auth.DoYouHaveAnAccount')}} <a href="{{Route('parent_register')}}">{{trans('register.Sign Up')}}</a></p>
                            </div>
                              ...
                              @endif
                                <form method="POST" action="{{route('login-parent')}}">
                                    ...
                                    <div class="remember">
                                        ...
                                        <div class="auth">
                                            <a href="{{route('password.request.parent')}}">{{trans("auth.ForgotPassword")}}</a>
                                        </div>
                                    </div>
                                    <div class="input-item me-auto ms-0">
