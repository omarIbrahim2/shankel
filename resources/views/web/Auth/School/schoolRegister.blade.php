                                    ...
                                    <form method="POST" action="{{ route('school-register') }}"
                                        ...
                                        <div class="input-item me-auto ms-0">
                                            <input type="text" name="name_en" value="{{ old('name_en') }}"
                                                placeholder="{{ trans('school.name_en') }}">
                                            <span>
                                        ...
                                        <div class="input-item me-auto ms-0">
                                            <input type="text" name="name_ar" value="{{ old('name_ar') }}"
                                                placeholder="{{ trans('school.name_ar') }}">
                                            <span>
                                                <i class="fa-solid fa-user"></i>
                                            </span>
                                            @error('name_ar')
                                        ...
                                        <div class="input-item me-auto ms-0">
                                            <input placeholder="Date Of establishment" value="{{ old('establish_date') }}"
                                                class=" eventDayPicker" type="text" name="establish_date"
                                                id="date" />
                                            <span>
                                        ...
                                        <div class="input-item me-auto ms-0">
                                            <select id="selectEduSystem" class="form-select"
                                                aria-label="Default select example" name="edu_systems_id">
                                                <option selected disabled>{{ trans('school.eduSystem') }} </option>
                                                @foreach ($eSystems as $system)
                                                    <option {{ old('edu_systems_id') == $system->id ? 'selected' : '' }}
                                        ...
                                        <div class="input-item me-auto ms-0 ">
                                            ...
                                            <div class="select-cont">
                                                @foreach ($grades as $grade)
                                                    <div class="checkbox">
                                                        <input type="checkbox" name="grade_id[]"
                                                            value="{{ $grade->id }}" id="{{ $grade->name() }}"
                                                            @if (is_array(old('grade_id')) && in_array($grade->id, old('grade_id'))) checked @endif>
                                        ...
                                        <div class="input-item me-auto ms-0 radios school-type">
                                            ...
                                            <div class="radio">
                                                ...
                                                <label
                                                    class="custom-out-btn  @if (old('type') == 'School') radio-checked @endif"
                                                    for="school">{{ trans('register.School') }}</label>
                                            </div>

                                            <div class="radio">
                                                <input type="radio" name="type" value="Center" id="center">
                                                <label
                                                    class="custom-out-btn  @if (old('type') == 'Center') radio-checked @endif"
                                                    for="center">{{ trans('register.center') }}</label>
                                            </div>

                                            <div class="radio">
                                                <input type="radio" name="type" value="KG" id="kg">
                                                <label
                                                    class="custom-out-btn @if (old('type') == 'KG') radio-checked @endif"
                                                    for="kg">{{ trans('register.kg') }}</label>
                                            </div>
                                            @error('type')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="input-item me-auto ms-0">
                                            <input value="{{ old('free_seats') }}" type="number" name="free_seats"
                                                placeholder="{{ trans('school.freeSeats') }}">
                                            <span>
                                                <i class="fa-solid fa-user"></i>
                                            </span>
                                            @error('free_seats')
